...
local hlgroups = {
  ...
  SpellBad = { undercurl = true, sp = dimRed },
  SpellCap = { undercurl = true, sp = dimYellow },
  ...
  ["@markup.list"] = { fg = normalFg },
  ["@markup.list.unchecked.markdown"] = { fg = normalFg },
  ["@markup.list.checked.markdown"] = { link = "Comment" },
  ["@lsp.type.class.markdown"] = { link = "@markup.list.checked.markdown" },
  ...
  DiagnosticVirtualTextError = { bg = nil, fg = dimRed, bold = true },
  DiagnosticVirtualTextHint = { bg = nil, fg = dimBlue, bold = true },
  DiagnosticVirtualTextInfo = { bg = nil, fg = dimBlue, bold = true },
  DiagnosticVirtualTextWarn = { bg = nil, fg = dimYellow, bold = true },
  ...
  RenderMarkdownInlineHighlight = { bg = darkYellow, sp = dimYellow },
