...
local c_macroBg0             = "#0D0D0D"
local normal_bg              = "#111111"
local c_macroBg2             = "#1D1D1D"
local c_macroBg3             = "#0D0D0D" -- changed from #282727 to fix box in lualine
local selection_light_gray   = "#2e2e2e"
local c_macroBg5             = "#625E5A"
local c_macroBlue0           = "#658594"
local c_macroBlue1           = "#8BA4B0"
local c_macroFg0             = "#C9C9C9"
...
local hlgroups = {
  ...
  Normal = { fg = c_macroFg0, bg = c_macroBg0 },
  ...
  SpellBad = { undercurl = true, sp = c_lotusRed0 },
  SpellCap = { undercurl = true, sp = c_carpYellow },
  SpellLocal = { undercurl = true, sp = c_carpYellow },
  SpellRare = { undercurl = true, sp = c_carpYellow },
  ...
  GitSignsCurrentLineBlame = { fg = c_macroAsh, italic = true },
